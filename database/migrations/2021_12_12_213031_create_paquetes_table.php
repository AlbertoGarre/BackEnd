...
class CreatePaquetesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('paquetes', function (Blueprint $table) {
            ...
            $table-> string('r_atencion', 255);
            $table-> string('r_telefono', 255);
            $table-> string('r_contacto', 255);
            $table-> string('r_observaciones', 255);
            ...
            $table-> string('e_escalera', 255);
            $table-> string('e_planta', 255);
            $table-> string('e_puerta', 255);
            $table-> string('e_destinatario', 255);
            $table-> string('e_telefono', 255);
            $table-> string('e_atencion', 255);
            $table-> string('e_observaciones', 255);
